...
let exerciseLibrary: [Exercise] = [
    ...
    Exercise(name: "Supino declinado com barra", sets: 3, reps: "10 reps", equipment: .barra, muscle: "Peito inferior", symbol: "figure.strengthtraining.traditional", instructions: ["Pés fixos, banco declinado.", "Mantenha a lombar no banco durante todo o movimento."]),
